...
object OffsetManager {
    /**
     *
     * @param gmallstartup 主题 topic
     * @param daugroup     消费者组
     * @param offsetRanges 消费kafka后的不同分区对应的 offsets
     */
